...
WebUI.click(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/input_None_programs'))

WebUI.click(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/input_Visit Date (Required)_visit_date'))

WebUI.click(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/td_22'))

WebUI.setText(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Exam QA')
