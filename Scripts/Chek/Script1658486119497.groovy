...
//
//WebUI.click(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/td_27'))
//
//WebUI.setText(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Testing')
//
